...
<head>
    ...
    if (isset($_GET['type']) && $_GET['type'] != '') {
        ...
        if ($type == 'status') {
            ...
            $update_status_sql = "update `inventory` set status='$status' where id='$id'";
                                ...
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        ...
                                        <form class="d-inline-flex">
                                            <a href="add-inventary.php" class="align-items-center btn btn-theme d-flex">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($res)) { ?>
                                                        <tr>
                                                            ...
                                                            $pro = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `product` WHERE `id` = '$product'"));
                                                            ?>
                                                            <td><?php echo $pro['name'] ?></td>
                                                            <?php
                                                            $sizee = $row['size'];
                                                            $si = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `size` WHERE `id` = '$sizee'"));
                                                            ?>
                                                            ...
                                                            <td>
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a href="add-inventary.php?id=<?php echo $row['id']; ?>">
