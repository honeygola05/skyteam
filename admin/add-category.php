                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="theme-form theme-form-2 mega-form">
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input class="form-control" name="name" type="text" placeholder="Category Name" value="<?php echo $name ?>"  required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="form-group col-sm-9">
                                                            <input class="form-control" type="file" name="image" placeholder="Category Image" value="<?php echo $image ?>" <?php echo $image ?>  required>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="col-sm-3 col-form-label form-label-title">Category
                                                            Image Alt Tag</label>
                                                        <div class="form-group col-sm-9">
                                                            <input class="form-control" type="text" name="image_alt_tag"  placeholder="Category Image" value="<?php echo $image_alt_tag ?>"  required>
