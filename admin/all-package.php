...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/packages.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Apr 2024 05:07:02 GMT -->
...
<head>
    ...
    if (isset($_GET['type']) && $_GET['type'] != '') {
        ...
        if ($type == 'status') {
            ...
            $update_status_sql = "update package set status='$status' where id='$id'";
            mysqli_query($con, $update_status_sql);
        }

        if ($type == 'delete') {
            $id = get_safe_value($con, $_GET['id']);
            $select_sql = "SELECT image FROM package WHERE id='$id'";
            ...
            if ($result) {
                ...
                $uploadsDirectory = '../media/package/';
                                ...
                                <div class="card-body">
                                    <div class="title-header option-title d-sm-flex d-block">
                                        ...
                                        <div class="right-options">
                                            <ul>
                                                ...
                                                <li>
                                                    <a class="btn btn-solid" href="add-package.php">Add package</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="table-responsive">
                                            <table class="table all-package theme-table table-package" id="table_id">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Image</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="table-image">
                                                                    <img src="../media/package/<?= $image[0] ?>" class="img-fluid" alt="">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a href="add-package.php?id=<?php echo $row['id']; ?>">
