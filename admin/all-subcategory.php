...
<head>
    ...
    if (isset($_GET['type']) && $_GET['type'] != '') {
        ...
        if ($type == 'delete') {
            ...
            // $select_sql = "SELECT image FROM subcategory WHERE id='$id'";
            ...
            //   echo $delete_sql = "DELETE FROM subcategory WHERE id='$id'";
            //     mysqli_query($con, $delete_sql);

            //     // Step 3: Unlink the image file from the storage
            //     $uploadsDirectory = '../media/subcategory/';
            //     $filePath = $uploadsDirectory . $filename;

            //     // Check if the file exists before attempting to delete it
            //     if (file_exists($filePath)) {
            //         unlink($filePath); // Delete the file
            //         echo "SubCategory and image file deleted successfully";
            //     } else {
