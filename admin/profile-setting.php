...
<head>
    ...
    if (isset($_POST['change_details'])) {
        ...
        $sql = mysqli_query($con, "UPDATE `admin_users` SET `username`='$username',`password`='$password' WHERE `id` = '1'");
        if ($sql) {
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <?php
                                            $data = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `admin_users`"));
                                            ?>
