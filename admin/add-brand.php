...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/add-new-brand.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Apr 2024 05:07:03 GMT -->
    ...
    if (isset($_POST['submit_brand'])) {
        ...
        if ($msg == '') {
            if (isset($_GET['id']) && $_GET['id'] != '') {
                ...
                mysqli_query($con, "UPDATE `brand` SET `name`='$name', `url`='$url' WHERE `id`='$id'");
            } else {
             
                $insert_query = "INSERT INTO `brand` (`name`, `url`) VALUES ('$name','$url')";
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="theme-form theme-form-2 mega-form">
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input class="form-control" name="name" type="text" placeholder="Brand Name" value="<?php echo $name ?>" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- <div class="mb-4 row align-items-center">
                                                    <div class="col-sm-3 form-label-title">Select brand Icon</div>
                                                    <div class="col-sm-9">
                                                ...
                                                <button class="btn btn-solid" name="submit_brand" type="submit">Submit</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/add-new-brand.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Apr 2024 05:07:04 GMT -->
