...
<head>
    ...
    if (isset($_POST['submit_banner'])) {
        ...
        $subheading = get_safe_value($con, $_POST['subheading']);
        ...
        if ($msg == '') {
            if (isset($_GET['id']) && $_GET['id'] != '') {
                if ($_FILES['image']['name'] != '') {
                    ...
                    mysqli_query($con, "UPDATE `banner` SET `image`='$image',`image_alt_tag`='$image_alt_tag',`heading`='$heading',`subheading`='$subheading',`price`='$price' WHERE `id`='$id'");
                } else {
                    $update_query = "UPDATE `banner` SET `image`='$image',`image_alt_tag`='$image_alt_tag',`heading`='$heading',`subheading`='$subheading',`price`='$price' WHERE `id`='$id'";
                ...
                move_uploaded_file($_FILES['image']['tmp_name'], "../media/banner/" . $image);
                $insert_query = "INSERT INTO `banner`(`image`,`image_alt_tag`, `heading`, `subheading`, `price`) 
        VALUES ('$image','$image_alt_tag','$heading','$subheading','$price')";
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="theme-form theme-form-2 mega-form">
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="col-sm-3 col-form-label form-label-title">Heading</label>
                                                        <div class="form-group col-sm-9">
                                                            <input class="form-control" type="text" name="heading" <?php echo $heading ?> placeholder="Heading" value="<?php echo $heading ?>">

                                                        </div>
                                                    </div>
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="col-sm-3 col-form-label form-label-title">Sub Heading</label>
                                                        <div class="form-group col-sm-9">
                                                            <input class="form-control" type="text" name="subheading" <?php echo $subheading ?> placeholder="Sub Heading" value="<?php echo $subheading ?>">
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="form-group col-sm-9">
                                                            <input class="form-control" type="text" name="price" <?php echo $price ?> placeholder="Price" value="<?php echo $price ?>">
