                                ...
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        ...
                                        <form class="d-inline-flex">
                                            <a href="add-brand.php" class="align-items-center btn btn-theme d-flex">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!-- <td>
                                                                <div class="table-image">
                                                                    <?php
                                                                    echo "<a target='_blank' href='" . "../media/brand/" . $row['image'] . "'><img width='50px' src='" . "../media/brand/" . $row['image'] . "'/></a>";
                                                                    ?>
                                                                </div>
                                                            </td> -->
                                                            ...
                                                            <td>
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a href="add-brand.php?id=<?php echo $row['id']; ?>">
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/brand.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Apr 2024 05:07:03 GMT -->
