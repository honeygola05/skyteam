...
<head>
    ...
    if (isset($_GET['type']) && $_GET['type'] != '') {
        ...
        if ($type == 'status') {
            ...
            $update_status_sql = "update `size` set status='$status' where id='$id'";
        ...
        if ($type == 'delete') {
            ...
            $delete_sql = "DELETE FROM `size` WHERE id='$id'";
                                ...
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        ...
                                        <form class="d-inline-flex">
                                            <a href="add-size.php" class="align-items-center btn btn-theme d-flex">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a href="add-size.php?id=<?php echo $row['id']; ?>">
