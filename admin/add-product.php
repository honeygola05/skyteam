                                    ...
                                    <div class="col-sm-8 m-auto">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                ?>
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="form-label-title col-sm-3 mb-0">Product
                                                            Url</label>
                                                        <div class="col-sm-9">
                                                            <input class="form-control" type="text" name="url" value="<?php echo $url ?>" placeholder="Product Url" required>
                                                        </div>
                                                    </div>
                                                <?php } ?>
                                                <div class="mb-4 row align-items-center">
                                                ...
                                                <!-- <div class="mb-4 row align-items-center">
                                                    <label class="col-sm-3 col-form-label form-label-title">Select Brand</label>
                                                    <div class="col-sm-9">
                                                        <select class="js-example-basic-single w-100" name="brand" required>
                                                            ...
                                                            if ($brand) {
                                                                ...
                                                                $res1 = mysqli_query($con, $sql1);
                                                                $row1 = mysqli_fetch_assoc($res1);
                                                                echo '<option value="' . $brand . '" selected>' . $row1['name'] . '</option>';
                                                            } else {
                                                                echo '<option value="" selected>Choose Brand</option>';
                                                            }
                                                ...
                                                <div class="mb-4 row align-items-center">
                                                    <label class="col-sm-3 col-form-label form-label-title">Select Material</label>
                                                    <div class="col-sm-9">
                                                        <select class="js-example-basic-single w-100" name="material" required>
                                                            <?php
                                                            if ($material) {
                                                                $sql1 = "SELECT * FROM `material` WHERE `id` = '$material'";
                                                                $res1 = mysqli_query($con, $sql1);
                                                                $row1 = mysqli_fetch_assoc($res1);
                                                                echo '<option value="' . $material . '" selected>' . $row1['name'] . '</option>';
                                                            } else {
                                                                echo '<option value="" selected>Choose Material</option>';
                                                            }
                                                ...
                                                <!-- <div class="mb-4 row align-items-center">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="js-example-basic-single w-100" name="subcategory">
                                                            <?php
                                                            if ($subcategory) {
                                                                $sql1 = "SELECT * FROM `subcategory` WHERE `id` = '$subcategory'";
                                                                $res1 = mysqli_query($con, $sql1);
                                                                $row1 = mysqli_fetch_assoc($res1);
                                                    ...
                                                    <div class="mb-4 row align-items-center" id="image_box">
                                                        ...
                                                        for ($i = 0; $i < count($all_image); $i++) { ?>
                                                            <div class="col-sm-6" id="image_container_<?php echo $i; ?>">
                                                                ...
                                                                <img src="../media/product/<?php echo $all_image[$i] ?>" alt="" style="width: 100px">
                                                            </div>
                                                ...
                                                <!-- <div class="mb-4 row align-items-center">
                                                    <label class="form-label-title col-sm-3 mb-0">Youtube Video Link</label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control" type="text" name="link" value="<?php echo $link ?>" placeholder="Youtube Video Link">
                                                    </div>
                                                </div> -->
                                                <div class="mb-4 row align-items-center">
                                                ...
                                                <?php if (isset($_GET['id'])) { ?>
                                                    <div class="mb-4 row align-items-center" id="price_box">
                                                        <label class="col-sm-3 col-form-label form-label-title">Prices</label>
                                                        <?php
                                                        $all_measures = json_decode($measure, true);
                                                        $all_base_prices = json_decode($base_price, true);
                                                        $all_discounted_prices = json_decode($discounted_price, true);
                                                        $count = count($all_measures); // assuming all arrays have same length

                                                        for ($i = 0; $i < $count; $i++) { ?>
                                                            <div class="row align-items-center price_group" id="price_group_<?php echo $i; ?>">
                                                                <div class="mb-3 col-sm-3">
                                                                    <input class="form-control" name="measure[]" type="text" placeholder="Measure" value="<?php echo htmlspecialchars($all_measures[$i]); ?>" required>
                                                                </div>
                                                                <div class="mb-3 col-sm-3">
                                                                    <input class="form-control" name="base_price[]" type="text" placeholder="Base Price" value="<?php echo htmlspecialchars($all_base_prices[$i]); ?>" required>
                                                                </div>
                                                                <div class="mb-3 col-sm-3">
                                                                    <input class="form-control" name="discounted_price[]" type="text" placeholder="Discounted Price" value="<?php echo htmlspecialchars($all_discounted_prices[$i]); ?>" required>
                                                                </div>
                                                                <?php if ($i != 0) { // Only show remove button if not first one 
                                                                ?>
                                                                    <div class="mb-3 col-sm-2">
                                                                        <button type="button" class="btn btn-sm btn-danger mt-2" onclick="remove_existing_price(<?php echo $i; ?>)">Remove</button>
                                                                    </div>
                                                                <?php } ?>
                                                            </div>
                                                        <?php } ?>
                                                        <div class="col-sm-3 offset-sm-3 mt-2">
                                                            <button type="button" class="btn btn-sm btn-info" onclick="add_more_price()">Add Price</button>
                                                        </div>
                                                    </div>
                                                <?php } else { ?>
                                                    <div class="mb-4 row align-items-center" id="price_box">
                                                        <label class="col-sm-3 col-form-label form-label-title">Prices</label>
                                                        <div class="row align-items-center price_group" id="price_group_0">
                                                            <div class="mb-3 col-sm-3">
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/add-new-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Apr 2024 05:07:03 GMT -->
