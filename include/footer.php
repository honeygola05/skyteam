        ...
        <div class="row y-gap-40 justify-between ">
          <div class="col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="mt-30">
              ...
              <a href="tel:<?= $contact['phone'] ?>" class="text-18 fw-500 text-blue-1 mt-5"><?= $contact['phone'] ?></a>
            </div>

            <div class="mt-35">
              <div class="text-14 mt-30">Need live support?</div>
              <a href="mailto:<?= $contact['email'] ?>" class="text-18 fw-500 text-blue-1 mt-5"><?= $contact['email'] ?></a>
            </div>
          </div>
