...
<head>
    ...
    if (isset($_POST['submit_info_co'])) {
        ...
        $email2 = get_safe_value($con, $_POST['email2']);
        ...
        if ($msg == '') {
            if (isset($_GET['id']) && $_GET['id'] != '') {
                ...
                $update_query = "UPDATE `info_co` SET `address`='$address', `phone`='$phone',`phone2`='$phone2', `email`='$email' , `email2`='$email2', `map`='$map' ,`location`='$location' ,`facebook`='$facebook', `insta`='$insta', `twitter`='$twitter' WHERE `id`='$id'";

                mysqli_query($con, $update_query);
            } else {
                $insert_query = "INSERT INTO `info_co` ( `address`, `phone`,`phone2`, `email`, `email2`, `map`, `location`, `facebook`, `insta`, `twitter`)
            VALUES ('$address', '$phone', '$phone2', '$email','$email2','$map', '$location', '$facebook', '$insta','$twitter')";
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="theme-form theme-form-2 mega-form">
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="form-label-title col-sm-3 mb-0">Email2</label>
                                                        <div class="col-sm-9">
                                                            <input class="form-control" name="email2" type="email" placeholder="Email2" value="<?php echo $email2 ?>">
                                                        </div>
                                                    </div>
