...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/tour-grid-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jun 2025 05:57:33 GMT -->
            ...
            <aside class="sidebar y-gap-40">
              <div class="sidebar__item -no-border">
                <div class="px-20 py-20 bg-light-2 rounded-4">
                  <h5 class="text-18 fw-500 mb-10">Search Tours</h5>
                  <div class="row y-gap-20 pt-20">
                    ...
                    <div class="col-12">
                      <div class="px-20 py-10 bg-white rounded-4">
                        ...
                        <div class="searchMenu-date  js-form-dd js-calendar js-calendar-el">
                ...
                <div class="col-lg-4 col-sm-6">
                  ...
                  <a href="package.php?url=<?= $package['url'] ?>" class="hotelsCard -type-1 ">
                    <div class="hotelsCard__image">
                      ...
                      <div class="cardImage ratio ratio-1:1">
                        <div class="cardImage__content">
                          ...
                          <img class="rounded-4 col-12" src="media/package/<?= $image[0] ?>" alt="<?= $package['image_alt_tag'] ?>">
                    ...
                    <div class="hotelsCard__content mt-10">
                      ...
                      <p class="text-light-1 lh-14 text-14 mt-5"><?= $package['location'] ?></p>
                      ...
                      <div class="mt-5">
                        <div class="fw-500">
                          Starting from <span class="text-blue-1">CA$<?= $package['price'] ?></span>
                        </div>
                      </div>
                    </div>
                  </a>
...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/tour-grid-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jun 2025 05:57:35 GMT -->
